...
- [ ] Port Bazel Starlark `test_suite/testdata/go` into xUnit conformance tests with a reusable harness (started: added initial harness and loop/comprehension subset).
